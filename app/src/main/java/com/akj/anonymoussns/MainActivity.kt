...
class MainActivity : AppCompatActivity() {
                        ...
                        snapshot?.let { snapshot ->
                            ...
                            post?.let {
                                ...
                                if (prevChildKey == null) {
                                    ...
                                    // 글이 중간에 삽입된 경우 prevChildKey 로 한단계 앞의 데이터의 위치를 찾은뒤 데이터를 추가한다.
    ...
    inner class MyAdapter : RecyclerView.Adapter<MyViewHodler>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHodler {
            return MyViewHodler(LayoutInflater.from(this@MainActivity).inflate(R.layout.card_post, parent, false))
        }
